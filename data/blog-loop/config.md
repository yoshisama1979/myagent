...
| 頻度の例外（2026-07-08 社長決定） | **blog-write / blog-improve は週次（月曜 05:30 / 06:00）に右サイズ化**（完成在庫10本がレビュー・公開待ちで凍結中＝毎日起動しても no-op のため）。診断の blog-loop は日次のまま。反応tick（mailbox 新着）は従来どおり即起動。公開ボトルネック解消後は日次へ戻す |
